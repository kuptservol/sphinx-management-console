...
public class StopDeltaMainCollectionAdminTest extends TestEnvironmentDeltaMainCollectionHelper {
...
//    @Ignore
    public void stopDeltaMainCollectionDistributedServer() throws InterruptedException {
        ...
        testExecutor.stopAllProcesses(PROJECT_PATH + "/development/sphinx.console-admin/sphinx.console-admin-service/src/main/resources/changesets/deltaMainTests/stopAllProcesses/stopAllProcesses.xml", collectionName);
