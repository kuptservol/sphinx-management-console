...
public class SchedulePlainCollectionTest extends AbstractScheduleCollectionTest {

    @Override
    protected String getCollectionName() {
        return TestEnvironmentPlainCollectionHelper.TEST_COLLECTION_SIMPLE_ONE_SERVER_NAME;
    }
