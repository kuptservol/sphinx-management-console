...
public class FullIndexingPlainCollectionAttributesNoChangeAdminTest extends TestEnvironmentPlainCollectionHelper {

    private static String fullRebuildSearchText;

    @Autowired
    protected RebuildPlainCollectionAdminTest rebuildPlainCollectionAdminTest;
...
//    @Ignore
    public void makeCollectionFullRebuildAttributesNoChangeIndexTest() throws InterruptedException {
        ...
        testExecutor.executeChangesetWithCheck(PROJECT_PATH + "/development/sphinx.console-admin/sphinx.console-admin-service/src/main/resources/changesets/plainTests/fullIndexingPlainCollectionAttributesNoChange/makeCollectionFullRebuildIndex.xml");
    }
...
//    @Ignore
    public void deleteFullIndexDataTest() throws Throwable {
        testExecutor.executeChangesetWithCheck(PROJECT_PATH + "/development/sphinx.console-admin/sphinx.console-admin-service/src/main/resources/changesets/plainTests/fullIndexingPlainCollectionAttributesNoChange/deleteFullIndexData.xml");
        rebuildPlainCollectionAdminTest.rebuildPlainCollectionTest();
    }
...
//    @Ignore
    ...
    public void makeCollectionFullRebuildAttributesNoChangeApplyTest() throws Throwable {
        testExecutor.executeChangesetWithCheck(PROJECT_PATH + "/development/sphinx.console-admin/sphinx.console-admin-service/src/main/resources/changesets/plainTests/fullIndexingPlainCollectionAttributesNoChange/makeCollectionFullRebuildApply.xml");

        testExecutor.checkSearchSuccess(TEST_COLLECTION_SIMPLE_ONE_SERVER_NAME, searchingAgentServerIP, replica1SearchPort, testDataSourceTableColumnField, fullRebuildSearchText);
    }
