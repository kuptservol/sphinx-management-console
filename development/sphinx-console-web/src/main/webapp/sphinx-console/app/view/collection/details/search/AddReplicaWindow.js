Ext.define('sphinx-console.view.collection.details.search.AddReplicaWindow', {
...
//    height: 400,
    ...
    onCreateReplica : function() {
        sphinx-console.app.fireEvent('createReplica',
        //var uid = sphinx-console.app.getsphinx-consoleControllerReplicasController().onCreateReplica(
            ...
            Ext.getCmp('searchServerPort').getValue(), Ext.getCmp('distribPort').getValue());
