Ext.define('sphinx-console.store.ConfigurationTemplateDistributedConfiguration', {
    ...
    proxy: {
        ...
        api:{
           read:sphinx-console.util.Utilities.SERVER_URL + '/view/templates/distributedConfiguration',
