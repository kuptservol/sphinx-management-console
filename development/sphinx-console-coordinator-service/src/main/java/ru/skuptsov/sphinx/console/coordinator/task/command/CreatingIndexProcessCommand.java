...
@Component("START_CREATING_INDEX_PROCESS")
@Scope("prototype")
public class CreatingIndexProcessCommand<T extends IndexNameTask> extends AgentCommand<T> implements AsyncCommand {
    ...
    public AgentRemoteMethod getAgentRemoteMethod(IndexNameTask task) throws NoSuchMethodException {
        Object[] arguments = {task, task.getProcessName(), null};
