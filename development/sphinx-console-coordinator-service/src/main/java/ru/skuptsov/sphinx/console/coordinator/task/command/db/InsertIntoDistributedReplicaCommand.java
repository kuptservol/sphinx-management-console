...
@Component("INSERT_INTO_DISTRIBUTED_REPLICA")
@Scope("prototype")
public class InsertIntoDistributedReplicaCommand extends DbCommand<CreateDistributedReplicaTask> {
	@Autowired
    private CollectionService collectionService;

    @Override
    @SaveActivityLog
    public Status execute(CreateDistributedReplicaTask task) {
        logger.debug("INSERT_INTO_DISTRIBUTED_REPLICA STATE EXECUTION...");
